...
-- Tag table for storing blog tags; blogs and tags are many-to-many
CREATE TABLE IF NOT EXISTS tags (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL UNIQUE
);

-- Add a junction table to handle many-to-many relationships
...
-- Fourth: bulk blog data for testing
