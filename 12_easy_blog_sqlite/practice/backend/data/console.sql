...
-- The following are blog-related tables
...
-- Tag table for storing blog tags; blog and tag are in a many-to-many relationship
CREATE TABLE IF NOT EXISTS tags (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL UNIQUE
);

-- Add a junction table to handle the many-to-many relationship
...
-- Second, create - examples
-- Insert group/tag data
...
VALUES
  ...
  (3, 'The Art of Italian Cooking', 'Authentic Italian recipes passed down through generations.', 1, '/images/a1.avif'),
  (3, 'Street Food Adventures in Bangkok', 'Exploring the vibrant street food scene in Thailand.', 1, '/images/a2.avif'),
  (4, 'Dealing with Burnout', 'Recognizing the signs and taking action to recover.', 0, '/images/a3.avif'),
  (4, 'Time Management for Developers', 'Balancing coding, meetings, and personal time effectively.', 1, '/images/a4.avif'),
  (5, 'Hiking Trails in the Pacific Northwest', 'Discover breathtaking views and hidden gems in the mountains.', 1, '/images/a5.avif');
...
-- Third, delete, update, and query examples
-- Query
SELECT * FROM groups;
...
-- Query all tags for a specific blog
...
-- Query all blogs under a specific tag
SELECT b.title, b.user_id, b.published, b.created_at, u.username
FROM blogs b
JOIN users u ON b.user_id = u.id
JOIN blog_tags bt ON b.id = bt.blog_id
WHERE bt.tag_id = 1;  -- technical tag
...
-- Fourth: large blog dataset for testing

INSERT INTO blogs (user_id, title, content, published, img)
VALUES
  (3, 'Strategy travel focus beautiful walk.', 'One day I walked across a silent mountain. It taught me patience, silence, and appreciation.', 1, '/images/a5.avif'),
  (5, 'Unique data solve better moment.', 'Everything starts with asking the right questions. Then the answers become a natural flow.', 0, '/images/a6.avif'),
  (1, 'Developers seek wisdom before lunch.', 'Tech culture is not only about work. It’s about the community and balance between code and life.', 1, '/images/a3.avif'),
  (1, 'People knowledge enjoy truth reason.', 'We value ideas that spread easily. That’s how the internet became such a transformative place.', 0, '/images/a4.avif'),
  (4, 'Food styles reach across oceans.', 'Every dish has a story. Food is culture, history, and family passed from hand to hand.', 1, '/images/a2.avif'),
  (2, 'New designs reflect modern users.', 'User experience is not just design. It’s empathy and insight woven into every interface.', 0, '/images/a6.avif'),
  ...
  (3, 'Balance comes through daily habits.', 'Success isn’t a one-time goal—it’s a set of habits repeated every day.', 1, '/images/a1.avif'),
  ...
  (3, 'Curiosity leads to unexpected places.', 'Never stop asking why. It’s the first step to every discovery worth sharing.', 0, '/images/a6.avif'),
  (4, 'Trust builds stronger communities.', 'When we trust one another, we create safety. And from safety, innovation thrives.', 1, '/images/a5.avif'),
  (5, 'Learning never ends in this era.', 'Today’s skills become tomorrow’s foundation. Stay humble and keep building.', 1, '/images/a4.avif'),
  ...
  (3, 'Ideas evolve with conversation.', 'The best ideas are forged in dialogue—not isolation.', 1, '/images/a3.avif'),
  ...
  (5, 'Nature heals and inspires action.', 'Time outdoors rewires our focus and fuels new perspectives.', 0, '/images/a5.avif'),
  (4, 'Books are slow wisdom in pages.', 'A book is the only place where you can examine a thought slowly and in detail.', 1, '/images/a1.avif'),
  (2, 'Learning from failure is strength.', 'Every mistake is feedback. Use it as a ladder, not a weight.', 1, '/images/a6.avif'),
  (1, 'Every project begins with vision.', 'Without vision, execution loses direction. Lead with purpose.', 1, '/images/a1.avif'),
  (3, 'Stories shape how we connect.', 'Storytelling is our most ancient tool for meaning-making and belonging.', 0, '/images/a2.avif'),
  (5, 'Solve problems, not symptoms.', 'Understanding the root cause is 90% of the work. Then the fix becomes clear.', 1, '/images/a2.avif'),
  (2, 'Calmness powers better decisions.', 'Panic leads to reactivity. Calm allows true reasoning.', 1, '/images/a3.avif'),
  ...
  (2, 'Empathy is tech’s secret ingredient.', 'The best technology solves human problems gently.', 1, '/images/a1.avif'),
  (4, 'Meditation resets creative minds.', 'Stillness creates the space for new connections.', 1, '/images/a4.avif'),
  (3, 'Challenge sparks personal growth.', 'Discomfort is data—telling us where to explore next.', 1, '/images/a2.avif'),
  (5, 'Great leaders listen before acting.', 'Silence is often more powerful than speech.', 0, '/images/a5.avif'),
  (1, 'Create systems, not chaos.', 'Organize once so you can focus daily.', 1, '/images/a1.avif'),
  (3, 'Legacy is built day by day.', 'Your small actions compound into something great.', 0, '/images/a4.avif'),
  ...
  (1, 'Art connects beyond language.', 'Visuals carry feeling where words fall short.', 1, '/images/a1.avif'),
  (3, 'Simplicity is user’s best friend.', 'Less means more impact when it’s focused.', 1, '/images/a4.avif'),
  (2, 'Curated chaos is creativity.', 'Sometimes mess leads to magic.', 0, '/images/a6.avif'),
  ...
  (2, 'Energy flows where focus goes.', 'Attention is our most valuable currency.', 1, '/images/a6.avif'),
